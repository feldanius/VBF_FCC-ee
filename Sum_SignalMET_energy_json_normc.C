...
int Sum_SignalMET_energy_json_normc() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("SignalMET_energy.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    const char* outputFileName = "Sum_SignalMET_energy_histogram_json_normc.root";
