...
int Sum_BackWWMET_energy_json() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("BackWWMET_energy.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    //const char* outputFileName = "Sum_BackWWMET_energy_histogram_json.root";
    const char* outputFileName = "Sum_BackWWMET_energy_histogram_json_log.root";
