...
int Sum_SignalMET_momentum_x_correct_nojson() {
    const char* fileNames[] = {
        "SignalMET_momentum_x_events_019839222.root",
        "SignalMET_momentum_x_events_027985022.root",
        "SignalMET_momentum_x_events_067618566.root",
        "SignalMET_momentum_x_events_075207014.root",
        "SignalMET_momentum_x_events_088898158.root",
        "SignalMET_momentum_x_events_090014287.root",
        "SignalMET_momentum_x_events_129556080.root",
        "SignalMET_momentum_x_events_138935081.root",
        "SignalMET_momentum_x_events_176415634.root",
        "SignalMET_momentum_x_events_177743949.root",
        "SignalMET_momentum_x_events_178769856.root",
        "SignalMET_momentum_x_events_192707663.root",
        "SignalMET_momentum_x_events_008995949.root",
        "SignalMET_momentum_x_events_061640142.root",
        "SignalMET_momentum_x_events_107858353.root",
        "SignalMET_momentum_x_events_174244458.root",
        "SignalMET_momentum_x_events_180776309.root",
        "SignalMET_momentum_x_events_065244791.root",
        "SignalMET_momentum_x_events_034459462.root",
        "SignalMET_momentum_x_events_071153275.root",
        "SignalMET_momentum_x_events_090844778.root",
        "SignalMET_momentum_x_events_158628525.root"
    };
    ...
    if (cumulativeHist) {
       ...
       const char* outputFileName = "Sum_SignalMET_momentum_x_correct_nojson.root";
...
int main() {
    Sum_SignalMET_momentum_x_correct_nojson();  // Llamada a la función principal.
