...
void processFiles(const std::vector<TString>& inputFileList, const TString& inputDir) {
    ...
    for (const auto& inputFile : inputFileList) {
        ...
        jsonData["OutputFile"] = "SignalMET_energy_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "SignalMET_mass_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "SignalMET_momentum_x_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "SignalMET_momentum_y_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "SignalMET_momentum_z_" + inputFileNameWithoutExt + ".root";
    ...
    std::ofstream jsonOutput("SignalMET_energy.json");
    //std::ofstream jsonOutput("SignalMET_mass.json");
    //std::ofstream jsonOutput("SignalMET_momentum_x.json");
    //std::ofstream jsonOutput("SignalMET_momentum_y.json");
    //std::ofstream jsonOutput("SignalMET_momentum_z.json");
