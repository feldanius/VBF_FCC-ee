...
int Sum_SignalJET_momentum_z_correct_nojson() {
    const char* fileNames[] = {
        "SignalJET_momentum_z_events_019839222.root",
        "SignalJET_momentum_z_events_027985022.root",
        "SignalJET_momentum_z_events_067618566.root",
        "SignalJET_momentum_z_events_075207014.root",
        "SignalJET_momentum_z_events_088898158.root",
        "SignalJET_momentum_z_events_090014287.root",
        "SignalJET_momentum_z_events_129556080.root",
        "SignalJET_momentum_z_events_138935081.root",
        "SignalJET_momentum_z_events_176415634.root",
        "SignalJET_momentum_z_events_177743949.root",
        "SignalJET_momentum_z_events_178769856.root",
        "SignalJET_momentum_z_events_192707663.root",
        "SignalJET_momentum_z_events_008995949.root",
        "SignalJET_momentum_z_events_061640142.root",
        "SignalJET_momentum_z_events_107858353.root",
        "SignalJET_momentum_z_events_174244458.root",
        "SignalJET_momentum_z_events_180776309.root",
        "SignalJET_momentum_z_events_065244791.root",
        "SignalJET_momentum_z_events_034459462.root",
        "SignalJET_momentum_z_events_071153275.root",
        "SignalJET_momentum_z_events_090844778.root",
        "SignalJET_momentum_z_events_158628525.root"
    };
    ...
    if (cumulativeHist) {
       ...
       const char* outputFileName = "Sum_SignalJET_momentum_z_correct_nojson.root";
...
int main() {
    Sum_SignalJET_momentum_z_correct_nojson();  // Llamada a la función principal.
