...
int cut_deltaphi_10_150_mass_invmass_bg_zh_tautauh_MET() {
...
"/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023/IDEA/wzp6_ee_tautauH_ecm365/events_186940475.root"
    ...
    TH1F* hist_MET = new TH1F("hist_MET", "MET después de los cortes", 100, 0, 400);
    ...
    TFile* output_file = TFile::Open("cut_deltaphi_10_150_mass_invmass_bg_zh_tautauh_MET.root", "RECREATE");
    if (output_file) {
        hist_MET->Write();
        output_file->Close();
    } else {
