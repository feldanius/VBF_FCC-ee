...
int Sum_BackZZJET_energy_json_normc() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("BackZZJET_energy.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    const char* outputFileName = "Sum_BackZZJET_energy_histogram_json_normc.root";
