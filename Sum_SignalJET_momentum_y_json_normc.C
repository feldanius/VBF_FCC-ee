...
int Sum_SignalJET_momentum_y_json_normc() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("SignalJET_momentum_y.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    const char* outputFileName = "Sum_SignalJET_momentum_y_histogram_json_normc.root";
