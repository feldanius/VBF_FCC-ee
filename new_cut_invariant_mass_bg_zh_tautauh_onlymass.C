...
int new_cut_invariant_mass_bg_zh_tautauh_onlymass() {
...
// Crear un histograma para la masa invariante
    ...
    for (const auto& filename : filenames) {
        ...
        for (Long64_t i = 0; i < tree->GetEntries(); ++i) {
            ...
            // Crear los vectores Lorentz de los jets que cumplen con el corte de masa
    ...
    TFile* output_file = TFile::Open("new_cut_invariant_mass_jets_histogram_bg_zh_tautauh_400_onlymass.root", "RECREATE");
    if (output_file) {
