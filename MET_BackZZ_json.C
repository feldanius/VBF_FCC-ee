...
void processFiles(const std::vector<TString>& inputFileList, const TString& inputDir) {
    ...
    for (const auto& inputFile : inputFileList) {
        ...
        jsonData["OutputFile"] = "BackZZMET_energy_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZMET_mass_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZMET_momentum_x_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZMET_momentum_y_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZMET_momentum_z_" + inputFileNameWithoutExt + ".root";
    ...
    std::ofstream jsonOutput("BackZZMET_energy.json");
    //std::ofstream jsonOutput("BackZZMET_mass.json");
    //std::ofstream jsonOutput("BackZZMET_momentum_x.json");
    //std::ofstream jsonOutput("BackZZMET_momentum_y.json");
    //std::ofstream jsonOutput("BackZZMET_momentum_z.json");
