...
int Sum_BackZZMET_energy_json_normc() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("BackZZMET_energy.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    const char* outputFileName = "Sum_BackZZMET_energy_histogram_json_normc.root";
