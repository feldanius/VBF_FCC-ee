...
int Sum_BackZZJET_momentum_z_json_normc() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("BackZZJET_momentum_z.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    const char* outputFileName = "Sum_BackZZJET_momentum_z_histogram_json_normc.root";
