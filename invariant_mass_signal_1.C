...
"/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023/IDEA/wzp6_ee_nunuH_ecm365/events_180776309.root"
    ...
    TH1F* hist_invariant_mass = new TH1F("hist_invariant_mass", "Masa invariante de los jets", 100, 0, 600);
    ...
    TFile* output_file = TFile::Open("invariant_mass_jets_histogram_signal_600.root", "RECREATE");
    if (output_file) {
