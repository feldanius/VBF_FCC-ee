...
int Sum_SignalJET_momentum_y_correct_nojson() {
    const char* fileNames[] = {
        ...
        "SignalJET_momentum_y_events_008995949.root",
        "SignalJET_momentum_y_events_061640142.root",
        "SignalJET_momentum_y_events_107858353.root",
        "SignalJET_momentum_y_events_174244458.root",
        "SignalJET_momentum_y_events_180776309.root",
        "SignalJET_momentum_y_events_065244791.root",
        "SignalJET_momentum_y_events_034459462.root",
        "SignalJET_momentum_y_events_071153275.root",
        "SignalJET_momentum_y_events_090844778.root",
        "SignalJET_momentum_y_events_158628525.root"
    };
    ...
    if (cumulativeHist) {
       ...
       const char* outputFileName = "Sum_SignalJET_momentum_y_correct_nojson.root";
...
int main() {
    Sum_SignalJET_momentum_y_correct_nojson();  // Llamada a la función principal.
