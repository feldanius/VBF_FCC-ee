...
int cut_reference_point_displacement_histogram_bg_zh_tautauh() {
...
"/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023/IDEA/wzp6_ee_tautauH_ecm365/events_186940475.root"
    ...
    TFile* output_file = TFile::Open("cut_reference_point_displacement_histogram_bg_zh_tautauh.root", "RECREATE");
    if (output_file) {
