...
int new_cut_invariant_mass_bg_zh_mumuh_onlymass() {
...
"/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023/IDEA/wzp6_ee_mumuH_ecm365/events_197337122.root"
    ...
    TFile* output_file = TFile::Open("new_cut_invariant_mass_jets_histogram_bg_zh_mumuh_400_onlymass.root", "RECREATE");
    if (output_file) {
