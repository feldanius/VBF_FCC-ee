...
void processFiles(const std::vector<TString>& inputFileList, const TString& inputDir) {
    ...
    for (const auto& inputFile : inputFileList) {
        ...
        jsonData["OutputFile"] = "BackZZJET_energy_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZJET_mass_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZJET_momentum_x_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZJET_momentum_y_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackZZJET_momentum_z_" + inputFileNameWithoutExt + ".root";
    ...
    std::ofstream jsonOutput("BackZZJET_energy.json");
    //std::ofstream jsonOutput("BackZZJET_mass.json");
    //std::ofstream jsonOutput("BackZZJET_momentum_x.json");
    //std::ofstream jsonOutput("BackZZJET_momentum_y.json");
    //std::ofstream jsonOutput("BackZZJET_momentum_z.json");
