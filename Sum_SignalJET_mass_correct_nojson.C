...
int Sum_SignalJET_mass_correct_nojson() {
    ...
    if (cumulativeHist) {
       ...
       const char* outputFileName = "Sum_SignalJET_mass_correct_nojson.root";
...
int main() {
    Sum_SignalJET_mass_correct_nojson();  // Llamada a la función principal.
