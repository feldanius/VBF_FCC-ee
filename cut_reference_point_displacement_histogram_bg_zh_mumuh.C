...
int cut_reference_point_displacement_histogram_bg_zh_mumuh() {
...
"/eos/experiment/fcc/ee/generation/DelphesEvents/winter2023/IDEA/wzp6_ee_mumuH_ecm365/events_197337122.root"
    ...
    TFile* output_file = TFile::Open("cut_reference_point_displacement_histogram_bg_zh_mumuh.root", "RECREATE");
    if (output_file) {
