...
int Sum_SignalMET_energy_correct_nojson() {
    const char* fileNames[] = {
        "SignalMET_energy_events_019839222.root",
        "SignalMET_energy_events_027985022.root",
        "SignalMET_energy_events_067618566.root",
        "SignalMET_energy_events_075207014.root",
        "SignalMET_energy_events_088898158.root",
        "SignalMET_energy_events_090014287.root",
        "SignalMET_energy_events_129556080.root",
        "SignalMET_energy_events_138935081.root",
        "SignalMET_energy_events_176415634.root",
        "SignalMET_energy_events_177743949.root",
        "SignalMET_energy_events_178769856.root",
        "SignalMET_energy_events_192707663.root",
        "SignalMET_energy_events_008995949.root",
        "SignalMET_energy_events_061640142.root",
        "SignalMET_energy_events_107858353.root",
        "SignalMET_energy_events_174244458.root",
        "SignalMET_energy_events_180776309.root",
        "SignalMET_energy_events_065244791.root",
        "SignalMET_energy_events_034459462.root",
        "SignalMET_energy_events_071153275.root",
        "SignalMET_energy_events_090844778.root",
        "SignalMET_energy_events_158628525.root"
    };
    ...
    if (cumulativeHist) {
       ...
       const char* outputFileName = "Sum_SignalMET_energy_correct_nojson.root";
...
int main() {
    Sum_SignalMET_energy_correct_nojson();  // Llamada a la función principal.
