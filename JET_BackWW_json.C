...
void processFiles(const std::vector<TString>& inputFileList, const TString& inputDir) {
    ...
    for (const auto& inputFile : inputFileList) {
        ...
        jsonData["OutputFile"] = "BackWWJET_energy_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackWWJET_mass_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackWWJET_momentum_x_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackWWJET_momentum_y_" + inputFileNameWithoutExt + ".root";
        //jsonData["OutputFile"] = "BackWWJET_momentum_z_" + inputFileNameWithoutExt + ".root";
    ...
    std::ofstream jsonOutput("BackWWJET_energy.json");
    //std::ofstream jsonOutput("BackWWJET_mass.json");
    //std::ofstream jsonOutput("BackWWJET_momentum_x.json");
    //std::ofstream jsonOutput("BackWWJET_momentum_y.json");
    //std::ofstream jsonOutput("BackWWJET_momentum_z.json");
