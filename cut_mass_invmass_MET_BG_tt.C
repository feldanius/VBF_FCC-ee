...
int cut_mass_invmass_MET_BG_tt() {
    // Nombres de los archivos ROOT
    vector<string> filenames = #include <iostream>
#include <vector>
#include <cmath>
#include "TFile.h"
#include "TTree.h"
...
int cut_mass_invmass_invariant_mass_bg_tt() {
    // Nombres de los archivos ROOT
...
// Crear un histograma para la masa invariante
    ...
    TFile* output_file = TFile::Open("cut_mass_invmass_invariant_mass_jets_histogram_bg_tt.root", "RECREATE");
    if (output_file) {
