...
int Sum_BackZZJET_momentum_y_json_normc() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("BackZZJET_momentum_y.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    const char* outputFileName = "Sum_BackZZJET_momentum_y_histogram_json_normc.root";
