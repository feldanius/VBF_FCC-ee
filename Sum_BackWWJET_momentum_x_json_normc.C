...
int Sum_BackWWJET_momentum_x_json_normc() {
    // Cargar el archivo JSON
    std::ifstream jsonFile("BackWWJET_momentum_x.json");
    json jsonData;
    jsonFile >> jsonData;
    ...
    const char* outputFileName = "Sum_BackWWJET_momentum_x_histogram_json_normc.root";
